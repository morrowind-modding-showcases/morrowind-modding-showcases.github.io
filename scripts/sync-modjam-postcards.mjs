...
const detailsByFile = new Map((existing.postcards || []).map((postcard) => [postcard.file, postcard]));
...
await writeFile(manifestUrl, `${JSON.stringify({ postcards: manifest }, null, 2)}\n`);
