(function () {
  ...
  function renderHome() {
    ...
    renderPage('<section class="hero">' +
      ...
      '</section>' +
      '<section class="stat-ribbon" aria-label="Archive totals"><div><strong>' + archiveData.summary.eventCount + '</strong><span>Modjams</span></div><div><strong>' + archiveData.summary.entryCount + '</strong><span>Mods</span></div><div><strong>' + archiveData.summary.modderCount + '</strong><span>Modders</span></div><div><strong>' + archiveData.summary.judgeAwardCount + '</strong><span>Judge Awards</span></div></section>' +
