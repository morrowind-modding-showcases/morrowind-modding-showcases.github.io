(function () {
  ...
  function renderHome() {
    ...
    main.innerHTML = '<section class="hero">' +
      ...
      '<section class="story-section"><div class="section-heading"><span class="eyebrow">A small event with a big history</span><h2>How the Modjam evolved</h2><p>The format changed as the community found its rhythm. The archive keeps those differences visible instead of forcing every year into one scoreboard.</p></div>' +
      '<div class="era-grid"><article><span class="era-year">2020</span><h3>Just for fun</h3><p>The first Winter and Summer jams had no winners. Prizes came from random drawings, and making something was the whole point.</p></article><article><span class="era-year">Spring 2021</span><h3>Popular Choice</h3><p>Danae took over and the community selected a Popular Choice winner for the one and only Spring Modjam.</p></article><article><span class="era-year">Summer 2021 →</span><h3>The judging panel</h3><p>Placed winners arrived with Summer 2021. From Summer 2022 onward, judges could also invent one-off awards for anything that delighted them.</p></article></div></section>' +
