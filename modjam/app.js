(function () {
  ...
  function renderHome() {
    ...
    renderPage('<section class="hero">' +
      ...
      '<section class="awards-marquee"><div class="awards-marquee-copy section-heading-panel"><h2>Judge Awards</h2><p>Beginning in Summer 2022, judges started honoring the memorable details that do not fit on a scorecard.</p><a class="button button--paper" href="/modjam/awards" data-route>Visit the awards cabinet</a></div><div class="awards-showcase"><div class="award-ribbons">' + favorites.map(function (award, index) { return '<span style="--turn:' + (index % 2 ? '1.5deg' : '-1.5deg') + '">' + escapeHtml(award) + '</span>'; }).join('') + '</div><img class="awards-trophy" src="assets/images/trophy.webp" alt="" width="281" height="846" loading="lazy" decoding="async"></div></section>' +
