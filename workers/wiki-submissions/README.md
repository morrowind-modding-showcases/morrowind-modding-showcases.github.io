...
This manually deployed Cloudflare Worker accepts publicly attributed wiki proposals, verifies Turnstile and request limits, assigns the trusted contribution timestamp, dispatches the repository workflow that creates canonical review pull requests, and proxies single-mod Nexus metadata lookups without exposing the API key. See [`../../docs/wiki-contributions.md`](../../docs/wiki-contributions.md) for the complete maintainer workflow.
